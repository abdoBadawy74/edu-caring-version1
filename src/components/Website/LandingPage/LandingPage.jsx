      ...
      <div className="landing-page">
        ...
        <div className="register">
          <div className="person">
            <span>Register</span>
            <h3>Attendance</h3>
            <button><Link className="text-dark" to="/register-attendance">Sign up now</Link></button>
          </div>
          <div className="person">
            <span>Register</span>
            <h3>Speaker</h3>
            <button><Link className="text-dark" to="/register-speaker">Sign up now</Link></button>
          </div>
        </div>
        {/* End Register */}
